...
class DNN_Census_Kdd_mix(nn.Module):
    def __init__(self, input_size, hidden_sizes=[512, 128, 64, 32], output_size=1):
        super(DNN_Census_Kdd_mix, self).__init__()
