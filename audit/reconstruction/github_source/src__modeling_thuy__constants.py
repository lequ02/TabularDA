def create_path_dict(dataset_name, target_name):
    return {
        ...
        'synthetic': {
            ...
            'compare_sdv_categorical': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_compare_categoricalNB_100k.csv',
            'compare_sdv_gaussian': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_compare_gaussianNB_100k.csv',
            'compare_sdv_pca_gmm': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_compare_pca_gmm_100k.csv',
            'compare_sdv_xgb': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_compare_xgb_100k.csv',
            'compare_sdv_rf': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_compare_rf_100k.csv',
            
            
            'compare_sdv_tvae_gaussianNB': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_compare_gaussianNB_100k.csv',
            'compare_sdv_tvae_pca_gmm': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_compare_pca_gmm_100k.csv',
            'sdv_tvae_pca_gmm': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_pca_gmm_100k.csv',
            'sdv_tvae_categorical': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_categorical_100k.csv',
            'compare_sdv_tvae_rf': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_compare_rf_100k.csv',
            'compare_sdv_tvae_xgb': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_compare_xgb_100k.csv',
            'sdv_tvae_xgb': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_xgb_100k.csv',
            'compare_sdv_tvae_categoricalNB': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_compare_categoricalNB_100k.csv',
            'sdv_tvae_gaussian': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_gaussian_100k.csv',
            'sdv_tvae_rf': f'../../data/{dataset_name}/onehot_{dataset_name}_sdv_tvae_rf_100k.csv',
...
IN_DATA_PATHS = {
    ...
    #         'tvae': '../../data/mnist12/onehot_mnist12_sdv_tvae_100k.csv',
    #         'xgb': '../../data/mnist12/onehot_mnist12_sdv_xgb_100k.csv',
    #         'rf': '../../data/mnist12/onehot_mnist12_sdv_rf_100k.csv',
    #         'pca_gmm': '../../data/mnist12/onehot_mnist12_sdv_pca_gmm_100k.csv',
    #     },
    #     'target_name': 'label'
    # },
    # 'mnist28': {
    ...
    #         'tvae': '../../data/mnist28/onehot_mnist28_sdv_tvae_100k.csv',
    #         'xgb': '../../data/mnist28/onehot_mnist28_sdv_xgb_100k.csv',
    #         'rf': '../../data/mnist28/onehot_mnist28_sdv_rf_100k.csv',
    #         'pca_gmm': '../../data/mnist28/onehot_mnist28_sdv_pca_gmm_100k.csv',
    #     },
    #     'target_name': 'label'
    # },
