...
html_lines <- c('<!doctype html><html><head><meta charset="utf-8"><title>Paper comparison and hypothetical sensitivity</title>',
  ...
  '<h2>Synthetic data utility</h2><img src="../figures/29_four_panel_comparison.png" alt="Four panels comparing feature generators, target inclusion and synthesis approaches"><p><a href="../../FOUR_PANEL_COMPARISON_NOTES.md">Figure notes and statistical details</a></p>',
