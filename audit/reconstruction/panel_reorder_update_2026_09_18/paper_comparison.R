...
source(file.path(root, "plot_four_panel_comparison.R"), local = TRUE)
...
report_lines <- c("# Paper comparison and TVAE Covertype substitution", "",
  ...
  "## Figures", "",
  "Figures 22-29 are in ../figures as PNG and vector PDF. They are also included in ../legacy_artifacts_report.html. Input snapshots and hashes are in inputs/paper_comparison_manifest.json at the analysis-folder root.")
...
html_lines <- c('<!doctype html><html><head><meta charset="utf-8"><title>Paper comparison and hypothetical sensitivity</title>',
  ...
  '<h2>Synthetic data utility</h2><img src="../figures/29_four_panel_comparison.png" alt="Four panels comparing feature generators, target inclusion and synthesis approaches"><p><a href="../../FOUR_PANEL_STATISTICS.md">Comparison statistics</a> | <a href="../../FOUR_PANEL_COMPARISON_NOTES.md">Figure notes</a></p>',
