...
report_lines <- c("# Paper comparison and TVAE Covertype substitution", "",
  ...
  "## Figures", "",
  "Figures 22-27 are in ../figures as PNG and vector PDF. They are also included in ../legacy_artifacts_report.html. Input snapshots and hashes are in inputs/paper_comparison_manifest.json at the analysis-folder root.")
