...
#data
  ...
  parser.add_argument('--augment-option', dest='augment_option', help='Synthetic data option (ctgan or gaussian or categorical or pca_gmm)', type=str, default=None)
...
>>>>>>> ed8ca30ba (plots done for adult and census)
