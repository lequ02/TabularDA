...
The smaller CTGAN pilot uses `python scripts/run_corrected_pilot.py`. Its runs use the same names and metrics in separate `pilot_ctgan_v1` directories; see `audit/PILOT_RUN_SPEC.md`.
