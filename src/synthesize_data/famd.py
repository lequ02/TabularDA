...
class FAMD(pca.PCA):
    ...
    def fit(self, X, y=None):
        ...
        #     self.cat_cols_ = X.select_dtypes(include=["category", "object"]).columns.tolist()
        # else:
        #     self.cat_cols_ = self.cat_features
        ...
        print("num_cols_", self.num_cols_)
        print("cat_cols_", self.cat_cols_)
